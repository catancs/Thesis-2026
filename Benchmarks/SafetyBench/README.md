...
Sources:
- [SafetyBench HuggingFace Dataset](https://huggingface.co/datasets/thu-coai/SafetyBench)
- [SafetyBench Paper (ArXiv)](https://arxiv.org/abs/2309.07045)
- [SafetyBench GitHub Repo](https://github.com/thu-coai/SafetyBench)
